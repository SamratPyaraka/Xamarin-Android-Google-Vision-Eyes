...
namespace GoogleEyes
{
    class EyePhysics
    {
        ...
        private readonly long TIME_PERIOD_MS = 1000;

        private readonly float FRICTION = 2.2f;
        private readonly float GRAVITY = 40.0f;

        private readonly float BOUNCE_MULTIPLIER = 20.0f;

        // Allow slightly non-zero values to be considered to be zero, to converge to zero more quickly.
        private readonly float ZERO_TOLERANCE = 0.001f;
        ...
        // Velocity is independent of the readonly rendering coordinate system, so that we don't have to
